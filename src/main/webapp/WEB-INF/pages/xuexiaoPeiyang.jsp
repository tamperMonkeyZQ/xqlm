...
<script type="text/javascript" src="${path }/jsFiles/xuexiaoPeiyang.js"></script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <input type="reset" name="reset" style="display: none;" />
               ...
               <button type="button" onclick="addXuexiaoPeiyang()" class="btn btn-primary">提交</button>
            </div>
            </form>
            </div>
        </div><!-- /.modal-content -->
...
<div id="mydlg1" class="modal fade" id="myModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<label class="col-md-2 control-label">培养文件</label>
			<div class="col-md-3 ">
			<input type="file" id="file1" name="file1" class="form-control form-control-static" placeholder="请输入官方网址">
			</div>
			</div>
            <div class="modal-footer col-md-6">
            <!--用来清空表单数据-->
