    ...
    <div class="wpn">
        <div class="form-data pos">
            ...
            <div class="change-login">
                <p class="account_number on">软件校企联盟学生登录</p>
            ...
            <div class="r-forget cl">
                <a href="${pageContext.request.contextPath}/upStage/goUpStageReg.action" class="z">账号注册</a>
                <a href="${pageContext.request.contextPath}/upStage/goUpStageGetPass.action" class="y">忘记密码</a>
            </div>
