...
<script type="text/javascript" src="${path }/jsFiles/yxuser.js"></script>
...
<div class="panel panel-default">
  ...
  <div class="form-group"  >
    <div class="col-md-2 ">
    <input type="text" class="form-control" id="userSearch" name="userSearch" placeholder="请输入院校名称或者登陆账号">
    </div>
  </div>
...
<div id="mydlg" class="modal fade" id="myModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="form-group">
			<label class="col-md-2 control-label">院校名称</label>
			<div class="col-md-3 ">
			<input type="text" id="userUnit"  name="userUnit" class="form-control form-control-static" placeholder="请输入院校名称">
			<input type="hidden" id="userRole" name="userRole" value="2">
			</div>
			</div>
			...
			<div class="form-group">
			<label class="col-md-2 control-label">院校简介</label>
			<div class="col-md-3">
...
<div id="mydlg1" class="modal fade" id="myModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="form-group">
			<label class="col-md-2 control-label">院校账号：</label>
			<div class="col-md-3 ">
			...
			<label class="col-md-2 control-label">院校名称：</label>
			<div class="col-md-3 ">
			<input type="text" id="user_name1"  name="userName" class="form-control form-control-static" placeholder="请输入院校名称">
			</div>
			</div>
			...
			<label class="col-md-2 control-label">院校简介：</label>
			<div class="col-md-3">
			<textarea rows="5" id="user_smry1" name="userSmry" cols="32" class="form-control form-control-static" placeholder="请输入院校简介"></textarea>
			</div>
			</div>
            <div class="modal-footer col-md-6">
            <!--用来清空表单数据-->
