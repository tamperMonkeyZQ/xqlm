(function() {
	var h = {},
		mt = {},
		c = {
			id: "713123c60a0e86982326bae1a51083e1",
			dm: ["36kr.com"],
	...
	h.w = {
		...
		Ma: 1,
		L: 2147483647,
		Z: "cc cf ci ck cl cm cp cu cw ds ep et fl ja ln lo lt nv rnd si st su v cv lv api tt u".split(" ")
	};
	(function() {
		var a = {
			o: {},
	...
	(function() {
		function a(a, d) {
			...
			b.d(d, "Function") && (e.readyState ? e.onreadystatechange = function() {
				if ("loaded" === e.readyState || "complete" === e.readyState) e.onreadystatechange = t, d()
			} : e.onload = function() {
				d()
			});
			e.src = a;
	...
	(function() {
		...
		function b() {
			...
			if ((!n || !k) && g && l) u = s, p = +new Date;
			else if (n && k && (!g || !l)) u = w, q += +new Date - p;
			n = g;
			k = l;
			y = setTimeout(b, 100)
		}
		...
		function d(a) {
			if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window)) l = "focus" == a.type || "focusin" == a.type ? s : w, b()
		}
		var e = mt.event,
			m = h.G,
			n = s,
	...
	(function() {
		...
		var f = mt.lang,
			...
			g = {
				...
				ia: function() {
					if (0 < g.s.length)
						for (var a = 0, b = g.s.length; a < b; a++) g.M(g.s[a]);
					g.s = t
				},
				M: function(a) {
					var b = a[0];
				...
				_setAutoPageview: function(a) {
					if (1 < a.length && (a = a[1], w === a || s === a)) g.e |= 2, h.b.S = a
				},
					...
					if (f.d(b, "Object")) {
						...
						if (900 >= m) l.call(this, b);
							...
							for (var m = Math.ceil(m / 900), p = "block|" + Math.round(Math.random() *
									e.L).toString(16) + "|" + m + "|", q = [], u = 0; u < m; u++) q.push(u), q.push(b.substring(900 * u, 900 * u + 900)), l.call(this, p + q.join("|")), q = []
					}
				},
		...
		a.prototype = {
			...
			I: function() {
				for (var a = document.location.hostname, b = 0, d = c.dm.length; b < d; b++)
					if (this.K(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[\/\?#].*/, "");
				return a
			},
			Q: function() {
			...
			Ga: function() {
				for (var a = [], b = 0, d = l.Z.length; b < d; b++) {
					var e = l.Z[b],
						f = this.a[e];
			...
			init: function() {
				try {
					this.Ja(), 0 === this.a.nv ? this.Fa() :
						this.N(".*"), h.b = this, this.da(), v.z("pv-b"), this.Ea()
				} catch (a) {
					var b = [];
					b.push("si=" + c.id);
			...
			da: function() {
				...
				a && (d.test(a) && e && g) && (this.a.rnd = Math.round(Math.random() * l.L), a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", l.protocol + "//" + c.js + f + ".js?" + this.a.rnd), f = document.getElementsByTagName("script")[0], f.parentNode.insertBefore(a,
					f))
			},
			aa: function(a) {
	...
	(function() {
		...
		if ("undefined" !== typeof h.b && (c.med || (!a.T || 7 < a.ya) && c.cvcc)) {
			...
			if (c.med) m = "/zoosnet", e = "swt", n = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i, g = {
				...
				g = {
					click: function() {
						for (var a = [], b = k(document.getElementsByTagName("a")), b = [].concat.apply(b, k(document.getElementsByTagName("area"))), b = [].concat.apply(b, k(document.getElementsByTagName("img"))), d, e, f, g = 0, m = b.length; g < m; g++) d = b[g], n !== r ? (e = d.getAttribute("onclick"), f = d.getAttribute("href"), p ? (d = d.getAttribute("id"), (n.test(e) || n.test(f) || p.test(d)) &&
			...
			if ("undefined" !== typeof g && "undefined" !== typeof n) {
				...
				m += /\/$/.test(m) ? "" : "/";
				var u = function(a, d) {
					if (q === d) return v(m + a, d), w;
					if (b.d(d, "Array") || b.d(d, "NodeList"))
						for (var e = 0, f = d.length; e < f; e++)
							if (q === d[e]) return v(m + a + "/" + (e + 1), d[e]), w
				};
				f.c(document, "mousedown", function(a) {
					...
					for (l(g, function(a, e) {
						...
						q !== document && l(d, u) !== w;) q = q.parentNode
				})
			}
		}
	})();
	(function() {
		...
		if ("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
			var e = {
				$: function() {
					for (var b = c.cvcf.length, d, g = 0; g < b; g++)(d = a.ka(decodeURIComponent(c.cvcf[g]))) && f.c(d, "click", e.ga())
				},
				ga: function() {
					return function() {
						h.b.a.et = 86;
		...
		a.prototype = {
			Aa: function(a) {
				if (this.f) this.h(a, 0);
					...
					try {
						this.f = new ActiveXObject("BDEXIE.BDExExtension.1"), this.U = s
					} catch (b) {
						this.U = w
					}
