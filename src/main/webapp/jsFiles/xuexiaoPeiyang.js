...
$(function (){
	...
	$('#test-table').bootstrapTable({
		...
		url: "xuexiao/xuexiaoPeiyang.action",
		cache : false,
		striped : true,// 隔行加亮
...
function xiazai(id){
	...
	//alert(id);
	window.open("/xqlm/xuexiao/download.action?id="+id);
}
function tongguo(id){
	$.ajax({
		url:'xuexiao/tongguo.action',
		dataType:'json',
		type:'post',
		traditional:true,
		data:{
...
function xiugaiPeiyang(){
	...
	$.ajax({
		url:'xuexiao/xiugaiPeiyang.action',
		type:'post',
		async: false,
		cache: false,
		contentType: false,
