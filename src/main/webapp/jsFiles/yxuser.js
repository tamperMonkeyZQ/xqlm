...
//条件查询
	function getUserByCon(){
		...
		$('#test-table').bootstrapTable({
			...
			url: "user/getYxUserByCon.action",
...
function getValue(id){
	$.ajax({
		...
		success:function(data){
			$("#user_id1").val(data.user.userId);
			$("#user_name1").val(data.user.userUnit);
			$("#user_phone1").val(data.user.userTel);
			$("#email1").val(data.user.userEmail);
			$("#user_web1").val(data.user.userWeb);
			$("#user_smry1").val(data.user.userSmry);
